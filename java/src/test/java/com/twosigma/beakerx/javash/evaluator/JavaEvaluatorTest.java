...
public class JavaEvaluatorTest {
  ...
  private static EvaluationObjectFactoryMock objectFactory;
  ...
  public void testMultipleCells() throws Exception {
    ...
    EvaluationObject seo = objectFactory.createSeo(code);
    javaEvaluator.evaluate(seo, code);
    //when
    String code2 = "a+a";
    EvaluationObject seo2 = objectFactory.createSeo(code2);
